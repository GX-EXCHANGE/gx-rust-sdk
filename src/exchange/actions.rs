...
impl Eip712 for UsdSend {
    ...
    fn struct_hash(&self) -> B256 {
        let items = (
            keccak256("GX ExchangeTransaction:UsdSend(string gx-exchangeChain,string destination,string amount,uint64 time)"),
            keccak256(&self.gx_exchange_chain),
...
impl Eip712 for ApproveAgent {
    ...
    fn struct_hash(&self) -> B256 {
        let items = (
            keccak256("GX ExchangeTransaction:ApproveAgent(string gx-exchangeChain,address agentAddress,string agentName,uint64 nonce)"),
            keccak256(&self.gx_exchange_chain),
            &self.agent_address,
...
impl Eip712 for Withdraw3 {
    ...
    fn struct_hash(&self) -> B256 {
        let items = (
            keccak256("GX ExchangeTransaction:Withdraw(string gx-exchangeChain,string destination,string amount,uint64 time)"),
            keccak256(&self.gx_exchange_chain),
            keccak256(&self.destination),
            keccak256(&self.amount),
            &self.time,
...
impl Eip712 for SpotSend {
    ...
    fn struct_hash(&self) -> B256 {
        let items = (
            keccak256("GX ExchangeTransaction:SpotSend(string gx-exchangeChain,string destination,string token,string amount,uint64 time)"),
            keccak256(&self.gx_exchange_chain),
            keccak256(&self.destination),
...
impl Eip712 for SendAsset {
    ...
    fn struct_hash(&self) -> B256 {
        let items = (
            keccak256("GX ExchangeTransaction:SendAsset(string gx-exchangeChain,string destination,string sourceDex,string destinationDex,string token,string amount,string fromSubAccount,uint64 nonce)"),
            keccak256(&self.gx_exchange_chain),
            keccak256(&self.destination),
...
impl Eip712 for ApproveBuilderFee {
    ...
    fn struct_hash(&self) -> B256 {
        let items = (
            keccak256("GX ExchangeTransaction:ApproveBuilderFee(string gx-exchangeChain,string maxFeeRate,address builder,uint64 nonce)"),
            keccak256(&self.gx_exchange_chain),
